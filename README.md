...
<header class="mb-4">
    ...
    <nav>
        alisonyeatman@gmail.comEmail</a> |
        https://www.linkedin.com/in/alisonyeatmanLinkedIn</a> |
        <span>Phone: 07563 137559</span>
    </nav>
    <button class="btn btn-light toggle-btn" onclick="toggleDarkMode()">Dark Mode</button>
</header>
